...
class _OrderPageState extends State<OrderPage> {
  ...
  void submitOrder() {
    if (selectedOption1 != null &&
      ...
      print('تم اختيار العنصر الثالث: $selectedOption3');
      print('النص المدخل: ${textEditingController.text}');
    } else {
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                ...
                child: const Text('حجز في وقت لاحق'),
              ),
              const SizedBox(height: 20),
              ElevatedButton(
